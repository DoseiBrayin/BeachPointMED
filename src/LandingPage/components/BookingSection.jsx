...
export const BookingSection = () => {
  return (
    <div className='bg-[url("src/assets/LandingImages/BookingSection/sand.svg")] px-[15px] my-[3rem] h-[10rem] flex flex-col justify-center items-center gap-5 md:flex-row
    md:h-[13.813rem]'>
      <BookYourCourtButton />
